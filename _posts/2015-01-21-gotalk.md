...
The Gotalk protocol's wire format is ASCII-based for easy on-the-wire inspection of data. The Gotalk protocol can thus be operated over any reliable byte transport. For example, here's a protocol message representing an operation request:
